...
import reducer, {ACTION_TYPES, createEntity, deleteEntity, getEntities, getEntity, getSearchEntities, reset, updateEntity,} from './bill.reducer';
...
describe('Entities reducer tests', () =>
{
  ...
  describe('Requests', () =>
  {
    ...
    {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_BILL_LIST), REQUEST(ACTION_TYPES.SEARCH_BILLS), REQUEST(ACTION_TYPES.FETCH_BILL)],
        {},
        state =>
        {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () =>
    {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_BILLS),
  ...
  describe('Successes', () =>
  {
    ...
    it('should search all entities', () =>
    {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_BILLS),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () =>
  {
    ...
    it('dispatches ACTION_TYPES.SEARCH_BILLS actions', async () =>
    {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_BILLS),
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_BILLS),
          payload: resolvedObject,
