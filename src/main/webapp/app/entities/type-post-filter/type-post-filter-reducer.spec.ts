...
describe('Entities reducer tests', () =>
{
    ...
    it('should set state to loading', () =>
    {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.SEARCH_TYPEPOSTFILTERS),
    ...
    it('should set state to updating', () =>
    {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.UPDATE_TYPEPOSTFILTER),
    ...
    it('should set a message in errorMessage', () =>
    {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_TYPEPOSTFILTERS),
          FAILURE(ACTION_TYPES.FETCH_TYPEPOSTFILTER),
          FAILURE(ACTION_TYPES.CREATE_TYPEPOSTFILTER),
          FAILURE(ACTION_TYPES.UPDATE_TYPEPOSTFILTER),
  ...
  describe('Successes', () =>
  {
    it('should fetch all entities', () =>
    {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_TYPEPOSTFILTER_LIST),
          payload,
        })
      ).toEqual({
        ...initialState,
    ...
    it('should search all entities', () =>
    {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_TYPEPOSTFILTERS),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () =>
  {
    ...
    it('dispatches ACTION_TYPES.UPDATE_TYPEPOSTFILTER actions', async () =>
    {
      const expectedActions = [
        ...
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_TYPEPOSTFILTER),
          payload: resolvedObject,
        },
      ];
