...
describe('Entities reducer tests', () => {
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_HANHCHINHVNS),
          FAILURE(ACTION_TYPES.FETCH_HANHCHINHVN),
          FAILURE(ACTION_TYPES.CREATE_HANHCHINHVN),
          FAILURE(ACTION_TYPES.UPDATE_HANHCHINHVN),
  ...
  describe('Successes', () => {
    it('should fetch all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_HANHCHINHVN_LIST),
          payload,
        })
      ).toEqual({
        ...initialState,
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_HANHCHINHVNS),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.UPDATE_HANHCHINHVN actions', async () => {
      const expectedActions = [
        ...
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_HANHCHINHVN),
          payload: resolvedObject,
        },
      ];
