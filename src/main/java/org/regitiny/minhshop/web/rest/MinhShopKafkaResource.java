...
//@RestController
@RequestMapping("/api/minh-shop-kafka")
public class MinhShopKafkaResource
{

  private final Logger log = LoggerFactory.getLogger(MinhShopKafkaResource.class);

  private final KafkaProperties kafkaProperties;
  private final KafkaProducer<String, String> producer;
  private final ExecutorService sseExecutorService = Executors.newCachedThreadPool();

  public MinhShopKafkaResource(KafkaProperties kafkaProperties)
  {
