...
import { deleteEntity, getEntity } from './image.reducer';
...
export const ImageDeleteDialog = (props: IImageDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="minhShopApp.image.delete.question">
        <Translate contentKey="minhShopApp.image.delete.question" interpolate={{ id: imageEntity.id }}>
